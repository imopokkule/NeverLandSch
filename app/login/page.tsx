  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-900 text-white gap-8">
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-400 text-lg">マダミス管理システムへようこそ</p>
      </div>
      ...
      <button
        ...
        className="flex items-center gap-3 px-8 py-4 bg-indigo-600 rounded-xl text-lg font-semibold hover:bg-indigo-700 transition"
      >
