              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    <div className="text-xs mb-0.5" style={{ color: "#9ec9b4" }}>日程未定</div>
                    <div className="text-xl font-bold" style={{ color: "#d8c840", fontFamily: "'Cinzel', serif" }}>
                      {s.undatedCount}
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="text-xs mb-0.5" style={{ color: "#9ec9b4" }}>日程あり</div>
                    <div className="flex items-baseline gap-1">
                      <span className="text-xl font-bold" style={{ color: "#4ecdc4", fontFamily: "'Cinzel', serif" }}>{s.count - s.undatedCount}</span>
